					...
					<tbody>
						...
						<tr>
							...
							<div class="cart_quantity_button">
								<form action="{{url('/also-update-cart')}}" method="post">
									{{ csrf_field()}}
	...
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
					<div class="headingWrap">
							<h3 class="headingTop text-center">Your Payment Method</h3>
							<h3 class="headingTop text-center"><a href="{{URL::to('buy-your-card')}}" class="btn btn-danger" style="color: white;">Buy Your Card</a></h3>	
					</div>
				
					{{-- <form action="{{url('/order-place')}}" method="post">
						{{csrf_field() }}
					  <input type="radio" name="payment_method" value="Handcash"> Hand Cash<br>
					  <input type="radio" name="payment_method" value="Debitcart"> Debit Card<br>
