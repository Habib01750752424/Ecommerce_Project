...
$name = Session::get('branch_admin_name');
$branch_place = Session::get('branch_place');
//print_r($id);
//echo $email;
if ($branch_id = $id and $branch_email = $email) {
	?><h2 style="text-align: center;color: #cde20f; margin-top: 100px;font-size: 70px;"><?php echo $branch_place?> Branch Admin Area</h2><?php
}
else {
	?><h2><?php dashboard(); ?></h2><?php
}
?>
